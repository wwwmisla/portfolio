...
const EducationCard = ({ title, institution, date, type, body, img }) => {
  return (
    <figure
      className={twMerge(
        'relative h-full w-92 cursor-pointer overflow-hidden rounded-xl border p-4 border-gray-50/[.1] bg-gradient-to-r bg-indigo to-storm hover:bg-royal hover-animation hover:scale-[1.015] hover:shadow-lg'
      )}
    >
